...
$client = new SoapClient(DIRECCION_BASE_PLAYER);

/** updatePlayer **/
$info = array('playerInfo' => array( 
    'playerId' => $_POST['inputID'],
    'ci' => $_POST['inputCI'],
...
<main role="main" class="container">
    ...
    <p><?php echo $data->serviceStatusPlayer->message; ?></p>
