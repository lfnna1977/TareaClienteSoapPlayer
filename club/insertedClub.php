...
<h1>Inserted Club</h1>
<p><?php echo $data->serviceStatus->message; ?></p>
    <div class="form-group">
    <h4>Name</h4>    
    <p><?php echo $data->clubInfo->name; ?></p>
  </div>
  <div class="form-group">
  <h4>City</h4>
  <p><?php echo $data->clubInfo->city; ?></p>
  </div>
  <div class="form-group">
    <h4>Telephone</h4>    
    <p><?php echo $data->clubInfo->telephone; ?></p>
  </div>
  <div class="form-group">
    <h4>Partners</h4>    
    <p><?php echo $data->clubInfo->numSocios; ?></p>
  </div>  
</main><!-- /.container -->
