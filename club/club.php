...
<main role="main" class="container">
  ...
  <div class="starter-template">
    ...
    <table class="table table-sm table-dark">
        ...
        <?php 
        $i = 1;
        foreach ($data->clubInfo as $valueClub) {
        ?>
            <tr>
            <th scope="row"><?php echo $i; ?></th>
            <td><?php echo $valueClub->name; ?></td>
            <td><?php echo $valueClub->city; ?></td>
            <td><?php echo $valueClub->telephone; ?></td>
            <td><?php echo $valueClub->numSocios; ?></td>
            <td><a href="viewClub.php?id=<?php echo $valueClub->clubId; ?>"><button type="button" class="btn btn-info">View</button></a><a href="updateClub.php?id=<?php echo $valueClub->clubId; ?>"><button type="button" class="btn btn-primary">Edit</button></a><a href="deleteClub.php?id=<?php echo $valueClub->clubId; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
            </tr>
        <?php 
          $i++;
        }
