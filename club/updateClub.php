...
/** getClubById **/
$data = $client->getClubById(array('clubId' => $_GET['id']));
...
<h1>Update Club</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputName" name="inputName" value="<?php echo $data->clubInfo->name; ?>">    
  </div>
  <div class="form-group">
    <label for="inputCity">City</label>
    <input type="text" class="form-control" id="inputCity" name="inputCity" value="<?php echo $data->clubInfo->city; ?>">
  </div>
  <div class="form-group">
    <label for="inputTelephone">Telephone</label>
    <input type="text" class="form-control" id="inputTelephone" name="inputTelephone" value="<?php echo $data->clubInfo->telephone; ?>">
  </div>
  <div class="form-group">
    <label for="inputPartners">Partners</label>
    <input type="text" class="form-control" id="inputPartners" name="inputPartners" value="<?php echo $data->clubInfo->numSocios; ?>">
  </div>
  <input type=hidden id="inputID" name="inputID" value="<?php echo $data->clubInfo->clubId; ?>">
