...
/** getCountryById **/
$data = $client->getCountryById(array('countryId' => $_GET['id']));
...
<h1>Update Country</h1>
    ...
    <input type="text" class="form-control" id="inputCode" name="inputCode" value="<?php echo $data->countryInfo->code; ?>">
  </div>
  <div class="form-group">
    <label for="inputName">Name</label>
    <input type="text" class="form-control" id="inputName" name="inputName" value="<?php echo $data->countryInfo->name; ?>">    
  </div>
  <input type=hidden id="inputID" name="inputID" value="<?php echo $data->countryInfo->countryId; ?>">
