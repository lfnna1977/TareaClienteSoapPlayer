...
<h1>Inserted Country</h1>
<p><?php echo $data->serviceStatusCountry->message; ?></p>
<form action="#" method="post">
    <div class="form-group">
    <h4>Code</h4>    
    <p><?php echo $data->countryInfo->code; ?></p>
  </div>
  <div class="form-group">
  <h4>City</h4>
  <p><?php echo $data->countryInfo->name; ?></p>
  </div>  
  </form>
